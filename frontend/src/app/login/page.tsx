...
/**
 * SATARK AI — Unified Portal & Institutional Login Gateway
 * Separate login experiences for:
 * 1. Civic / Citizen Portal (Public Access)
 * 2. Government Command Centre Login
 * 3. University / HEI Innovation Hub Login
 * 4. Industry & CSR Partnership Portal Login
 */
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight">
            Select Your <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">Stakeholder Portal</span>
          </h1>
          <p className="mt-3 text-sm sm:text-base text-slate-400 max-w-2xl mx-auto">
            SATARK AI separates public citizen reporting from authenticated institutional governance, academic R&D, and CSR funding management.
          </p>
        </div>

        {/* Public Citizen Banner Card */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 mt-1 max-w-xl">
                Are you a citizen or community member looking to report a societal issue or track an existing challenge? Click below to enter the dedicated Civic Portal.
              </p>
            </div>
          </div>
          <Link
        ...
        <div className="rounded-3xl bg-slate-900/90 border border-slate-800 shadow-2xl overflow-hidden backdrop-blur-xl grid grid-cols-1 md:grid-cols-12">
          {/* Left Column: Portal Selection Tabs */}
          <div className="md:col-span-5 p-6 bg-slate-950/60 border-r border-slate-800/80 flex flex-col justify-between">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all flex items-start gap-3.5 ${
                    activeTab === 'GOVT'
                      ? 'bg-gradient-to-r from-slate-900 to-slate-850 border-cyan-500/60 shadow-lg shadow-cyan-500/10'
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all flex items-start gap-3.5 ${
                    activeTab === 'HEI'
                      ? 'bg-gradient-to-r from-slate-900 to-slate-850 border-purple-500/60 shadow-lg shadow-purple-500/10'
                      : 'bg-slate-900/50 border-slate-800 hover:border-slate-700 text-slate-400'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all flex items-start gap-3.5 ${
                    activeTab === 'INDUSTRY'
                      ? 'bg-gradient-to-r from-slate-900 to-slate-850 border-amber-500/60 shadow-lg shadow-amber-500/10'
                      : 'bg-slate-900/50 border-slate-800 hover:border-slate-700 text-slate-400'
                  }`}
                >
                  ...
                  <div>
                    <h4 className={`text-sm font-bold ${activeTab === 'INDUSTRY' ? 'text-white' : 'text-slate-300'}`}>
                      3. Industry & CSR Partnership Portal
                    </h4>
                    <p className="text-xs text-slate-400 mt-0.5">
            ...
            <div className="mt-8 pt-4 border-t border-slate-800 text-[11px] text-slate-400 flex items-center gap-2">
              ...
              <span>Role-Based Access Control (RBAC) with JWT Encryption</span>
            </div>
          </div>
