...
import { Shield, MapPin, Building2, Landmark, HeartHandshake, User, ChevronDown, Activity } from 'lucide-react';
...
export const Navbar = () => {
  ...
  const navItems = [
    { href: '/citizen', label: 'Citizen Portal', icon: MapPin },
  ...
  return (
    <nav className="bg-slate-950/90 border-b border-slate-800 text-white sticky top-0 z-40 backdrop-blur-md">
      ...
      {/* Main Navbar */}
      <div className="max-w-7xl mx-mx px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        {/* Brand */}
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-medium">
              Report • Predict • Connect • Resolve
            </p>
          </div>
        </Link>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="text-left">
                <span className="block text-[10px] text-slate-400 leading-tight">Role Switcher</span>
